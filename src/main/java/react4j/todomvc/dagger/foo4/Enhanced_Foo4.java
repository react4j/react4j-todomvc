...
public final class Enhanced_Foo4
  extends Foo4
{
  public static class Factory
  {
    ...
    @Nonnull
    public Enhanced_Foo4 create( @Nonnull final Map<String, String> props )
    {
      return new Enhanced_Foo4( _enhancer, _repository, props );
    }
  }

  interface Enhancer
  {
    void enhance( Enhanced_Foo4 object );
  }

  // TODO This is private
  private Enhanced_Foo4( @Nonnull final Enhancer enhancer,
